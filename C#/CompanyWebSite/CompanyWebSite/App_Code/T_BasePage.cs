...
public class T_BasePage 
{
    ...
    {
        get { return System.Configuration.ConfigurationManager.AppSettings["tp_ulink"].ToString(); }
    }
    /// <summary>
    /// 首页模版
    /// </summary>
   ...
   /// </summary>
    ...
    public static string TemplateNewsDetail
    {
        get { return System.Configuration.ConfigurationManager.AppSettings["tp_newsdetail"].ToString();}
    }
    ...
    public static string TemplateDiChang
    {
        get { return System.Configuration.ConfigurationManager.AppSettings["tp_dichang"].ToString(); }
    }
    public static string TemplateXunTong
    {
        get { return System.Configuration.ConfigurationManager.AppSettings["tp_xuntong"].ToString(); }
    }
    public static string TemplateZhengQuang
    {
        get { return System.Configuration.ConfigurationManager.AppSettings["tp_zhengquang"].ToString(); }
    }
    public static string TemplateDiChangInfo
    {
        get { return System.Configuration.ConfigurationManager.AppSettings["tp_dichanginfo"].ToString(); }
    }
    public static string TemplateXunTongInfo
    {
        get { return System.Configuration.ConfigurationManager.AppSettings["tp_xuntonginfo"].ToString(); }
    }
    public static string TemplateZhengQuangInfo
    {
        get { return System.Configuration.ConfigurationManager.AppSettings["tp_zhengquanginfo"].ToString(); }
    }
