<%@ Page Language="C#" MasterPageFile="admin.master" AutoEventWireup="true" validateRequest="false" CodeFile="postedit.aspx.cs" Inherits="admin_postedit" Title="无标题页"%>
...
<script type="text/javascript">
    ...
    <p>
     ...
     <p>
        <label  class="label" for="<%=shopName.ClientID %>">外链接名称:</label>
        <asp:TextBox ID="shopName"   runat="server" Width="49%" CssClass="text"  Text="go to amazon"></asp:TextBox>
    </p>
     <p>
        <label  class="label" for="<%=shopLink.ClientID %>">外链接地址:</label>
        <asp:TextBox ID="shopLink"   runat="server" Width="49%" CssClass="text"></asp:TextBox>
    </p>
    <p>
