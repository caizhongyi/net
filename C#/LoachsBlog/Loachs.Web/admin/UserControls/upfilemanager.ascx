<%@ Control Language="C#" AutoEventWireup="true" CodeFile="upfilemanager.ascx.cs" Inherits="admin_UserControls_upfilemanager" %>
...
<div  class="right">           
    ...
    <p><asp:FileUpload ID="FileUpload1" runat="server" Width="180px" /></p>
