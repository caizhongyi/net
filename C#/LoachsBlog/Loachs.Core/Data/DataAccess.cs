...
namespace Loachs.Data
{
    ...
    {
        private static readonly string path = "Loachs.Core";
        ...
        {
            string className = path + ".Access.Tag";
        ...
        {
            string className = path + ".Access.Category";
        ...
        {
            string className = path + ".Access.Post";
        ...
        {
            string className = path + ".Access.User";
        ...
        {
            string className = path + ".Access.Link";
        ...
        {
            string className = path + ".Access.Comment";
       //     return (IComment)Assembly.Load(path).CreateInstance(className);
        ...
        {
            string className = path + ".Access.Statistics";
        ...
        {
            string className = path + ".Access.Setting";
