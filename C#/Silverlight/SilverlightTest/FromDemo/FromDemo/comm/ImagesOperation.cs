...
namespace Media
{
    public class ImagesOperation
    {
        ...
        /// <param name="angleY">Y座标扭曲度(以度为单位)</param>
        /// <param name="centerY">变换中心的Y座标</param>
        public void ImageReflection(Image imageReflection, double x, double y, double angle, double angleX, double centerX, double angleY, double centerY)
        {
            ...
            linGbrush.EndPoint = new Point(0, 0.1);
            ...
            Canvas.SetLeft(imageReflection, x);
            Canvas.SetTop(imageReflection, y);
        }
        #endregion
