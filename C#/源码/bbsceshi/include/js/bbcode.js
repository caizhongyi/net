/*
	...
	$Id: bbcode.js 20790 2009-10-21 09:08:40Z monkey $
*/
...
function bbcode2html(str) {
	...
	if(!fetchCheckbox('bbcodeoff')) {
		if(allowimgcode) {
			...
			str = str.replace(/\[attachimg\](\d+)\[\/attachimg\]/ig, function ($1, $2) {return '<img src="' + $('image_' + $2).src + '" border="0" aid="attachimg_' + $2 + '" width="' + $('image_' + $2).getAttribute('_width') + '" alt="" />';});
