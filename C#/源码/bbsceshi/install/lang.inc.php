...
<p>电子文本形式的授权协议如同双方书面签署的协议一样，具有完全的和等同的法律效力。您一旦开始安装 Discuz!，即被视为完全理解并接受本协议的各项条款，在享有上述条款授予的权力的同时，受到相关的约束和限制。协议许可范围以外的行为，将直接违反本授权协议并构成侵权，我们有权随时终止授权，责令停止损害，并保留追究相关责任的权力。</p></div>',
	...
	为了不断改进产品质量，改善用户体验，Discuz!7.1《康盛改善计划》，该系统有利于我们分析用户在论坛的操作习惯，进而帮助我们在未来的版本中对产品进行改进，设计出更符合用户需求的新功能。
...
$testdatacontent[0]['subject'] = '论坛运营秘籍 - Discuz! 7.1 新功能的妙用 ';
$testdatacontent[0]['message'] = <<<EOD

Discuz! 7.1 新推出的几个功能，都是围绕着提高论坛的互动性而设计的，好好利用这些新功能，对于提高论坛用户粘性，增强会员之间的互动性，大有脾益。下面我们来说说，如何根据论坛的实际情况，来合理的设置这些新功能。[p=30, 2, left]
...
论坛首页支持两种显示风格了：一种是传统的论坛版块列表的形式，这种形式历史悠久，被广大用户所熟悉，版块就像一本书的目录，用户可以根据版块来快速的确定自己感兴趣的话题在什么地方；第二种论坛首页形式就是7.1新推出的论坛动态，在这种形式下，论坛内的各种事件动态信息都汇集到论坛动态列表中，比如某人发的主题回复数超过1000了，某某的帖子被版主评为精华了等等。这种以事件为核心，动态信息为表现的形式，可以大大加强论坛用户之间的互动性，信息流动起来了，互动性就更容易产生，更能突出一个真实“社区”的感觉。
...
$testdatacontent[1]['subject'] = 'Discuz! 7.1 新功能——站长推荐 ';
$testdatacontent[1]['message'] = <<<EOD

Discuz! 7.1 新增站长推荐功能，管理员可以设置一部分帖子为“站长推荐”，被设置为“站长推荐”的这些帖子就会在帖子内容页面右下角以浮动窗口的形式展示给浏览者，如果有多个主题被设置为“站长推荐”则随机轮流显示。
站长推荐可以理解为一个全局主题推荐，管理员可以将一些版块重要信息，比如通知、公告等设置为站长推荐，以保证更多的用户可以浏览到，或者还可以在此加入广告帖进行赢利，一个功能多种用法，各位站长可以根据自身情况设置和使用。
“站长推荐”在后台的设置位置为：Discuz! 7.1 后台 => 广告 => 站长推荐
...
Discuz! 7.1新增的论坛热点功能，能够很好的满足主题聚焦的应用需求。该功能可以将社区中最抢眼的主题合显示到论坛首页的头部，方便用户快速在论坛中浏览热点信息。论坛热点的设置和 Discuz! 的其它功能一操作非常简单，只需要以管理员身份到后台简单开启即可。

我们截图来看一下开启后的效果：
[img]http://faq.comsenz.com/attachments/2009/09/9_200909110951061nyw4.gif[/img]
下面我们来说一下后台的开启方法：
进入 Discuz! 7.1 后台 => 界面 => 界面设置 => 首页设置：
...
到此论坛热点的开启和效果展示为大家讲解完毕了，怎么样，这个功能是不是很吸引你，还等什么，赶快安装最新版 Discuz! 7.1 或者将您的论坛升级到 Discuz! 7.1 来体验吧！
EOD;

$testdatacontent[3]['subject'] = 'Discuz! 7.1新特性——主题热度/评价';
$testdatacontent[3]['message'] = <<<EOD

Discuz!7.1 在对主题的操作上添加了新特性，即主题热度和主题评价。
...
主题热度是 Discuz!7.1 新增的特性，站长可以在后台设置主题热度值及热度增加权重值。当某个主题达到站点设置的热度时，会在主题列表页标题右侧显示热度图标，大大提高热度主题的浏览次数。
1、后台设置
...
主题评价是 Discuz!7.1 新增的特性，后台有是否开启该功能的开关，并且站长可以在后台设置评价图标显示级别。
1、后台设置
...
$testdatacontent[4]['subject'] = 'Discuz! 7.1 新特性——推荐主题';
$testdatacontent[4]['message'] = <<<EOD
D
Discuz!7.1 版本完善了推荐主题功能：推荐主题时可以修改主题标题、并有选择性地推荐主题中的图片等，用户体验有了很大的提高。
...
$testdatacontent[5]['subject'] = 'Discuz! 7.1 新特性——新手任务';
$testdatacontent[5]['message'] = <<<EOD

Discuz!7.1 在论坛任务方面有所改进，系统有针对性地自带了 7 个新手任务，无需站长添加。新注册用户将自动申请该任务，此功能可用于防止恶意注册及恶意灌水，或引导新手快速熟悉论坛。
...
3、回复某主题时
在快速回复框“发表回复”按钮旁勾选“关注主题”复选框
[img]http://faq.comsenz.com/attachments/2009/09/42_200909071426594Q6fh.gif[/img][p=30, 2, left][b]二、查看被关注的主题[/b][/p]
1、关注信息提示
...
[img]http://faq.comsenz.com/attachments/2009/09/42_200909071426597be40.gif[/img][p=30, 2, left][b]三、取消关注主题[/b][/p]
1、在已关注的主题的快速回复框下的“发表回复”按钮旁勾选“取消关注”复选框，这样回复后此主题将不再处于被关注状态
...
$testdatacontent[7]['subject'] = 'Discuz! 7.1 新特性——论坛动态';
$testdatacontent[7]['message'] = <<<EOD
Discuz! 7.1 增加了论坛动态实时浏览功能，用户除了浏览原来的版块列表界面外还可以切换到“论坛动态”里面查看论坛实时动态，此功能类似于 SNS 的动态查看功能，可以集中查看到所有好友的动态信息，而无需进入好友个人主页查看。
[img]http://faq.comsenz.com/attachments/2009/10/9_2009100915323019jA5.gif[/img]
站长可以在 Discuz! 7.1 后台设置论坛首页的默认显示风格，进入 Discuz! 7.1 系统设置 => 界面 => 界面设置 => 首页设置 => 首页显示风格：
[img]http://faq.comsenz.com/attachments/2009/10/9_200910091532302Z0N9.gif[/img]
经典版块列表：即论坛版块列表展示模式，也就是老版本的 Discuz! 的展示效果。
论坛实时动态：即 Discuz! 7.1 新增的动态实时查看功能，用户可以在此集中查看到所有好友的动态信息。
...
怎么样，是不是很方便？赶快安装全新的 Discuz! 7.1 或者升级您的论坛体验一下吧！
EOD;

$testdatacontent[8]['subject'] = 'Discuz! 7.1 新特性——提醒系统';
$testdatacontent[8]['message'] = <<<EOD
Discuz! 7.1 新增了提醒系统，提醒内容包括“全部”、“系统信息”、“好友信息”、“帖子信息”。上述这些信息主要有新信息则就会在导航的“提醒”那里出现新信息提示，如下图所示：
...
Discuz! 7.1 提醒系统更加细化了各个操作带来的信息提醒，一目了然的分类，使用和浏览信息更加清晰明确。
EOD;
...
分析会员的使用习惯，Discuz! 7.1 的编辑器有了很大的改进，界面更友好，突出显示常用操作图标，并且新增了很多功能。
...
Discuz! 7.1 前台 => 发帖，即可进入全新的 Discuz! 7.1 编辑器：
[img]http://faq.comsenz.com/attachments/2009/09/9_200909281123281iC4p.gif[/img]
从上图界面可以看出，Discuz! 7.1 的编辑器有了很大的改观，突出显示目前社区比较常用的表情、图片、音乐、视频、Flash、代码、引用，界面更加友好。
...
到此 Discuz! 7.1 最新编辑器介绍完了，怎么样？是不是超酷炫！而且使用起来更加得心应手，那么还等什么，赶快体验吧！

论坛运营秘籍 - Discuz!7.1 新功能的妙用：[url=http://faq.comsenz.com/viewnews-869]http://faq.comsenz.com/viewnews-869[/url]
...
Discuz! 7.1 在视频播放方面有了很大改进，不但支持播放 wmv rm rmvb flv swf avi asf mpgmpeg mov 等多种格式，还可以自动分析优酷、土豆、ku6三大主流视频网站的视频网址，而不需要再去找专门的转发引用地址，使得转发视频变得更容易更强大，下面为大家举例演示这三大主流视频网站的视频转发功能。
Discuz! 7.1 前台 => 发帖，即可进入全新 Discuz! 7.1 编辑器：
...
从上面的演示可以看出来，Discuz! 7.1 发布优酷、土豆、ku6 三大主流视频网站的视频变得非常容易，无需再费力找论坛引用地址，直接输入视频的网址系统就会自动解析获取最终的播放地址，还等什么，快快来亲身体验一把吧！
EOD;

$testdatacontent[11]['subject'] = 'Discuz!7.1 新特性——Manyou应用的开启';
$testdatacontent[11]['message'] = <<<EOD

Discuz!7.1 较之前的版本，在后台添加了 Manyou 应用的开关。做为插件的形式，站长可以在后台开启或关闭该功能。开启该功能后，会员在论坛也可以看到 Manyou 应用的动态信息及大家都在玩什么应用游戏，同时还可以参与进来。
下面请看详细介绍：
...
$testdatacontent[12]['subject'] = 'Discuz! 7.1 安装图文教程';
$testdatacontent[12]['message'] = <<<EOD

本教程讲解的全新安装 Discuz!7.1 的方法（以虚拟空间上安装 Discuz!7.1 为例演示）。安装 Discuz! 7.1 前请确保是否已经安装好了 UCenter 1.5，参考教程如下：
UCenter 1.5 安装图文教程：[url=http://faq.comsenz.com/viewnews-449]http://faq.comsenz.com/viewnews-449[/url]
UCenter 1.5 安装视频教程：[url=http://faq.comsenz.com/viewnews-494]http://faq.comsenz.com/viewnews-494[/url]
一、下载适合自己 Discuz!7.1 版本到本地或服务器
下载地址：[url=http://www.comsenz.com/downloads#down_discuz]http://www.comsenz.com/downloads#down_discuz[/url]
说明：官方提供了 4 种不同的编码。包括 GBK 简体中文版(推荐)、UTF-8 简体中文版、BIG5 繁体中文版(推荐)、UTF-8 繁体中文版。如果您的站点主要是国内会员，推荐您使用 GBK 版块。
...
将其中 upload 目录下的所有文件使用 FTP 软件以二进制方式（常见 FTP 软件二进制的设置方法[url=http://faq.comsenz.com/viewnews-373]http://faq.comsenz.com/viewnews-373[/url]）上传到空间（以下截图中使用的 FTP 软件为 FlashFXP，有关此工具的使用教程详见：FTP 使用教程），如下图所示：
...
关于目录权限修改可以参考：[url=http://faq.comsenz.com/viewnews-183]http://faq.comsenz.com/viewnews-183[/url]
...
三、安装过程
上传完毕后，开始在浏览器中安装 Discuz! 7.1 ，登录 UCenter 1.5 => 应用管理 => 添加新应用 => URL 安装 (推荐)：
...
为了不断改进产品质量，改善用户体验，Discuz!7.1测试版内置了统计系统，该统计系统收集论坛功能的运行数据包括各功能使用频率，功能内部元素的点击情况。这些数据有利于我们分析用户在论坛的操作习惯，进而帮助我们在未来的版本中对产品进行改进，设计出更符合用户需求的新功能。
该统计系统不会收集站点敏感信息，不收集用户资料，不存在安全风险，并且经过实际测试不会影响论坛的运行效率。
您安装使用本版本表示您同意加入《康盛改善计划》，Discuz!运营部门会通过对站点数据的分析为您提供运营指导建议，我们将提示您如何根据站点运行情况开启论坛功能，如何进行合理的功能配置，以及提供其他的一些运营经验等。
为了方便我们和您沟通运营策略，请您留下常用的网络联系方式：QQ、MSN、E-mail。
填写好联系方式后点击“提交”，也可以点击“跳过本步”直接完成安装。
[img]http://faq.comsenz.com/attachments/2009/10/9_2009101311182011sKXl.gif[/img]
安装完毕后进入 Discuz! 7.1 首页查看网站：
[img]http://faq.comsenz.com/attachments/2009/10/9_2009101311182012swWS.gif[/img]
至此，Discuz! 7.1 已经成功地安装完毕！您可以登录 Discuz! 7.1 站点并开始设置了。
EOD;

$testdatacontent[13]['subject'] = 'Discuz! 7.0到Discuz! 7.1升级图文教程';
$testdatacontent[13]['message'] = <<<EOD

本教程分三部分为大家讲解升级过程：升级前的准备、升级中的注意事项以及升级后需要进行的一些善后操作。[p=30, 2, left][b]一、升级前的准备[/b][/p]
1、下载 Discuz! 7.1 官方版到本地或者服务器上
下载地址：[url=http://download.comsenz.com/Discuz/7.1/]http://download.comsenz.com/Discuz/7.1/[/url]
在这里要说明一下：我们提供了 4 种不同的编码。包括 GBK 简体中文版(推荐)、UTF-8 简体中文版、BIG5繁体中文版(推荐)、UTF-8 繁体中文版，请根据您使用的 Discuz! 7.0 的编码，选择相应版本的 Discuz! 7.1论坛程序下载。
本次演示以 GBK 版本为例下载到本地，解压缩得到如下图所示的三个文件：
[img]http://faq.comsenz.com/attachments/2009/09/15_200909231743591odIN.gif[/img]
upload 这个目录下面的所有文件是我们需要上传到服务器上的可用程序文件；
readme 目录为产品介绍、授权、安装、升级、转换以及版本更新日志说明；
utilities 目录为论坛附带工具，包括我们这次升级要用到的 upgrade12.php 程序。
2、升级到 Discuz! 7.1 后原来的风格将不能继续使用，故此在升级之前先把风格换回默认风格，并设置其他风格不可用
用管理员登录论坛后台 => 界面 => 界面设置 => 全局：“论坛默认风格”选择“默认风格”，如图：
[img]http://faq.comsenz.com/attachments/2009/09/15_200909231743592jLXS.gif[/img]
用管理员登录论坛后台 => 界面 => 风格管理：将非默认的其他所有风格都设置为不可用，如图：
...
我们常用的对论坛程序及其附件的备份方法为：在原论坛根目录下新建一个目录 oldbbs，然后把除 attachments 外的其他所有文件全部移动到 oldbbs 目录中。当然，您也可以将所有论坛文件都移到到 oldbbs 目录中进行备份。
2）数据库备份
独立主机直接到 MySQL 的 data 目录拷贝一份当前 Discuz! 7.0 使用的数据库即可，记得拷贝之前停止 MySQL 服务，否则会造成备份数据的损坏。
...
具体各个选项的含义可以参考这个教程中的说明：[url=http://www.discuz.net/thread-744280-1-1.html]http://www.discuz.net/thread-744280-1-1.html[/url][p=30, 2, left][b]二、升级中的注意事项（以虚拟主机上的升级步骤做演示）[/b][/p]
...
说明：保留 Discuz! 7.0 的 config.inc.php 文件的原因是两个版本的这个文件没有做修改，保留是为了免去重新配置的麻烦。
2、上传 Discuz! 7.1 解压后 upload 目录下（除 attachments 、install 和 config.inc.php 文件外）的所有程序文件到服务器上
[img]http://faq.comsenz.com/attachments/2009/09/15_2009092317435981Gpy.gif[/img]
注：虚拟主机上传文件请一定使用二进制方式上传，独立主机直接在服务器上下载解压缩即可。
几种常见的 FTP 软件的二进制设置明：[url=http://faq.comsenz.com/viewnews-862?action-viewnews-itemid-373]http://faq.comsenz.com/?action-viewnews-itemid-373[/url]
3、设置目录权限
修改 config.inc.php、attachments、forumdata 、以及 forumdata/* （ forumdata下的所有文件夹）、templates、以及templates/*( templates 下的所有文件夹) 的目录属性为 777 ;Windows 系统给这些目录 IIS 来宾的读写权限。
关于目录权限修改可参考：[url=http://faq.comsenz.com/viewnews-183]http://faq.comsenz.com/viewnews-183[/url]
4、上传下载的 Discuz! 7.1 安装包的 ./utilities/upgrade12.php 到论坛程序根目录下
[img]http://faq.comsenz.com/attachments/2009/09/15_200909231743599hYd1.gif[/img]
5、在浏览器中运行 [url]http://www.domain.com/upgrade12.php[/url] 升级程序进行升级（其中 [url]http://www.domain.com[/url] 为你的论坛访问地址）
[img]http://faq.comsenz.com/attachments/2009/09/15_2009092317435910Go9J.gif[/img]
上图界面中点击“>> 如果您已确认完成上面的步骤,请点这里升级 ”链接开始升级，升级过程是自动跳转的，无需人工干预。
...
为了方便我们和您沟通运营策略，您可以留下常用的网络联系方式，也可以点击“跳过本步骤”。
重要功能设置：
[img]http://faq.comsenz.com/attachments/2009/09/15_2009092317435913RVPg.gif[/img]
重要功能设置用来引导站长对一些比较重要的功能进行优先设置，在这里您可以看到该功能的介绍及举例。
您可以点击“现在就进入后台设置”，来立即设置该功能；也可以点击“继续下一个功能”或“跳过”来跳过该功能的设置，以后设置。
升级完成：
[img]http://faq.comsenz.com/attachments/2009/09/15_2009092317435914F9iF.gif[/img][p=30, 2, left][b]三、升级后的一些善后操作[/b][/p]
1、删除服务器上的升级程序 upgrade12.php 。
...
4、如果需要以前的图片或文件，可以到 oldbbs 文件夹里找，当然如果确定不需要了或 Discuz!7.1 没问题了可以把 oldbbs 删除掉。
至此， Discuz! 7.0 到 Discuz! 7.1 升级成功！
