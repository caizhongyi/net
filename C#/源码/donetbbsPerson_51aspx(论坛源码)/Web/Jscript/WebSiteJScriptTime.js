...
var _VersionInfo="Version:Dos;2.0作者:美人草 MAIL: donetbbs@hotmail.com lenlenlong@hotmail.com"	//版本信息

//==================================================== WEB 页面显示部分 =====================================================
var strFrame;		//存放日历层的HTML代码
document.writeln('<iframe id=meizzDateLayer Author=wayx frameborder=0 style="position: absolute; width: 144; height: 214; z-index: 9998; display: none ;overflow: hidden;"></iframe>');
strFrame='<style>';
...
strFrame+='             onfocus="this.blur()" style="font-size: 12px; height: 20px" id=button1 name=button1><input Author=meizz class=button title="向前翻 1 月" type=button ';
strFrame+='             value="< " onclick="parent.meizzPrevM()" onfocus="this.blur()" style="font-size: 12px; height: 20px" id=button1 name=button1></td><td ';
strFrame+='             Author=meizz align=center><input Author=meizz type=button class=button value=Today onclick="parent.meizzToday()" ';
strFrame+='             onfocus="this.blur()" title="当前日期" style="font-size: 12px; height: 20px; cursor:hand" id=button1 name=button1></td><td ';
strFrame+='             Author=meizz align=right><input Author=meizz type=button class=button value=" >" onclick="parent.meizzNextM()" ';
strFrame+='             onfocus="this.blur()" title="向后翻 1 月" class=button style="font-size: 12px; height: 20px" id=button1 name=button1><input ';
strFrame+='             Author=meizz type=button class=button value=">>" title="向后翻 1 年" onclick="parent.meizzNextY()"';
strFrame+='             onfocus="this.blur()" style="font-size: 12px; height: 20px" id=button1 name=button1></td>';
...
tt.readOnly=true;
	...
	var th = tt;
	var ttop  = tt.offsetTop-82;     //TT控件的定位点高
