...
namespace WebSite.UserInfo
{
    public class Login : System.Web.UI.Page
    {
        ...
        public override void DataBind()
        {
            ...
            Components.SiteWebSetting.WebSiteTitle = MyConnection.GetResourcesXmlNode("Resource_WebSiteUserLoginTitle");
            ...
            UserControlMaster.WebSiteMasterBody = IDoNetBbs.GetFormat(UserControlMaster.WebSiteMasterBody, "WebSiteBoardListNavigate", MyConnection.GetResourcesXmlNode("Resource_WebSiteUserLoginTitle"));
            UserControlMaster.WebSiteMasterBody = IDoNetBbs.GetFormat(UserControlMaster.WebSiteMasterBody, "WebSitePageListTopInfo", null);
            UserControlMaster.WebSiteMasterBody += MyConnection.GetTempXmlNode("Resource_WebSiteUserLoginBody");
