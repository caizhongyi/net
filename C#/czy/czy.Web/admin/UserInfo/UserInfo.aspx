 ...
 <%--    <asp:HiddenField ID="n_idOrder" runat="server"  Value="asc"/>
     ...
     <asp:Repeater ID="Menu" runat="server" onitemcommand="Menu_ItemCommand" 
        ...
        <HeaderTemplate>
         ...
         <tr>
            <th> <asp:LinkButton ID="LinkButton1" runat="server" CommandName="order" CommandArgument="u_id" >ID</asp:LinkButton></th>
            <th> <asp:LinkButton ID="LinkButton2" runat="server" CommandName="order" CommandArgument="u_name"  >名称</asp:LinkButton></th>
        ...
        <ItemTemplate>
         <tr align="center" onmouseover="mouseover(this)" onmouseout="mouseout(this)"  onclick="RowClick('UserInfoEdit.aspx?id=<%#Eval("u_id") %>');">
          
            <td class="UserTableRow2 ellipsis" style="width:30%"><asp:Label ID="LabID" runat="server" Text='<%#Eval("u_id") %>'></asp:Label></td>
            <td class="UserTableRow2 ellipsis" style="width:30%"><asp:Label ID="LabTitle" runat="server" Text='<%#Eval("u_name") %>'></asp:Label></td>

            <td class="UserTableRow2" style="width:20%"><a href='UserInfoEdit.aspx?id=<%#Eval("u_id") %>'>编辑</a></td>
            <td class="UserTableRow2" style="width:20%"><asp:LinkButton ID="linkbtnDel" runat="server" CommandName="Del" CommandArgument='<%#Eval("u_id") %>'>删除</asp:LinkButton></td>
        </tr>
        </ItemTemplate>
        <FooterTemplate>
         </table>
