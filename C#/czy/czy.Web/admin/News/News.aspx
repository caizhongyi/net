<%@ Page Language="C#" AutoEventWireup="true" CodeFile="News.aspx.cs" Inherits="admin_Menu_Menu" %>
 ...
 <%--    <asp:HiddenField ID="n_idOrder" runat="server"  Value="asc"/>
     ...
     <asp:Repeater ID="Menu" runat="server" onitemcommand="Menu_ItemCommand" 
        ...
        <HeaderTemplate>
         ...
         <tr>
            <th> <asp:LinkButton ID="LinkButton1" runat="server" CommandName="order" CommandArgument="m_id" >ID</asp:LinkButton></th>
            <th> <asp:LinkButton ID="LinkButton2" runat="server" CommandName="order" CommandArgument="m_name"  >标题</asp:LinkButton></th>
            <th> <asp:LinkButton ID="LinkButton3" runat="server" CommandName="order" CommandArgument="m_url"  >内容</asp:LinkButton></th>
            <th> <asp:LinkButton ID="LinkButton5" runat="server" CommandName="order" CommandArgument="m_parentId"  >时间</asp:LinkButton></th>
                <th> <asp:LinkButton ID="LinkButton4" runat="server" CommandName="order" CommandArgument="m_parentId"  >所属类别</asp:LinkButton></th>
            <th> 编辑</th>
            <th> 删除</th>
        </tr>
        ...
        <ItemTemplate>
         <tr align="center" onmouseover="mouseover(this)" onmouseout="mouseout(this)"  onclick="RowClick('NewsEdit.aspx?id=<%#Eval("n_id") %>');">
          
            <td class="UserTableRow2 ellipsis" style="width:15%"><asp:Label ID="LabID" runat="server" Text='<%#Eval("n_id") %>'></asp:Label></td>
            <td class="UserTableRow2 ellipsis" style="width:15%"><asp:Label ID="LabTitle" runat="server" Text='<%#Eval("n_title") %>'></asp:Label></td>
            <td class="UserTableRow2 ellipsis" style="width:15%;"><a ><asp:Label ID="LabName" runat="server" Text='<%#Eval("n_content") %>'></asp:Label></a></td>
            <td class="UserTableRow2 ellipsis" style="width:15%"><asp:Label ID="LabSmallType" runat="server" Text='<%#  Eval("n_createDate") %>'></asp:Label></td>
            <td class="UserTableRow2 ellipsis" style="width:20%"><asp:Label ID="Label1" runat="server" Text='<%#  Eval("nt_name") %>'></asp:Label></td>
            <td class="UserTableRow2" style="width:15%"><a href='NewsEdit.aspx?id=<%#Eval("n_id") %>'>编辑</a></td>
            <td class="UserTableRow2" style="width:15%"><asp:LinkButton ID="linkbtnDel" runat="server" CommandName="Del" CommandArgument='<%#Eval("n_id") %>'>删除</asp:LinkButton></td>
        </tr>
        </ItemTemplate>
        <FooterTemplate>
         </table>
