<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Menu.aspx.cs" Inherits="admin_Menu_Menu" %>
     ...
     <asp:Repeater ID="Menu" runat="server" onitemcommand="Menu_ItemCommand" 
        ...
        <HeaderTemplate>
         ...
         <tr>
            ...
            <th> <asp:LinkButton ID="LinkButton2" runat="server" CommandName="order" CommandArgument="m_name"  >导航名称</asp:LinkButton></th>
            <th> <asp:LinkButton ID="LinkButton3" runat="server" CommandName="order" CommandArgument="m_url"  >URL</asp:LinkButton></th>
            <th> <asp:LinkButton ID="LinkButton5" runat="server" CommandName="order" CommandArgument="m_parentId"  >父级ID</asp:LinkButton></th>
        ...
        <ItemTemplate>
         <tr align="center" onmouseover="mouseover(this)" onmouseout="mouseout(this)"  onclick="RowClick('MenuEdit.aspx?id=<%#Eval("m_id") %>');">
          
            <td class="UserTableRow2" style="width:15%"><asp:Label ID="LabID" runat="server" Text='<%#Eval("m_id") %>'></asp:Label></td>
            <td class="UserTableRow2" style="width:15%"><asp:Label ID="LabTitle" runat="server" Text='<%#Eval("m_name") %>'></asp:Label></td>
            <td class="UserTableRow2" style="width:15%"><asp:Label ID="LabName" runat="server" Text='<%#Eval("m_url") %>'></asp:Label></td>
            <td class="UserTableRow2" style="width:15%"><asp:Label ID="LabSmallType" runat="server" Text='<%#  Eval("m_parentId") %>'></asp:Label></td>
            <td class="UserTableRow2" style="width:20%"><a href='MenuEdit.aspx?id=<%#Eval("m_id") %>'>编辑</a></td>
            <td class="UserTableRow2" style="width:20%"><asp:LinkButton ID="linkbtnDel" runat="server" CommandName="Del" CommandArgument='<%#Eval("m_id") %>'>删除</asp:LinkButton></td>
        </tr>
        </ItemTemplate>
        <FooterTemplate>
         </table>
