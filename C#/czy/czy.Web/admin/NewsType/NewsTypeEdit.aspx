<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewsTypeEdit.aspx.cs" Inherits="admin_NewsTypeEdit" %>
    ...
    <%--<div class="new_content" >--%>
      ...
      <div class="txt_content"><asp:TextBox ID="TxtName" runat="server" 
              CssClass="buttoncss" MaxLength="100" Width="250px"></asp:TextBox></div> </div>
                  <div class="item"><div class="txt_sideBar1"><span style="color:Red">* </span>父级：</div><div class="txt_content"><asp:DropDownList ID="DropType" runat="server" Width="150" ></asp:DropDownList></div> </div>
   <div class="item"><div class="txt_sideBar1"><span style="color:Red">&nbsp;</span>备注：</div><div class="txt_content">  
