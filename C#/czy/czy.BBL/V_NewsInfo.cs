...
namespace czy.BBL
{
    public class V_NewsInfo
    {
        ...
        public static DataSet GetCurrentData(int cur, int size)
        {
            ...
            Util.PagerQueryParams.TableId = "n_id";
            Util.PagerQueryParams.Order = " n_createDate asc";
            Util.PagerQueryParams.KeyFieldOrder = "asc";
            Util.PagerQueryParams.Colums = "*";
            Util.PagerQueryParams.Filter = "";
            DataSet ds = Util.IDataPager.GetCurrentPageData(cur);
            return ds;
        }
        public static DataSet GetCurrentData(int cur, int size,string orderColums,string order)
        {
            Util.PagerQueryParams.Size = size;
            Util.PagerQueryParams.TableName = "NewsInfo";
            Util.PagerQueryParams.TableId = "u_id";
            Util.PagerQueryParams.Order = orderColums + "" + order;
            Util.PagerQueryParams.KeyFieldOrder = "asc";
            Util.PagerQueryParams.Colums = "*";
            Util.PagerQueryParams.Filter = "";
            DataSet ds = Util.IDataPager.GetCurrentPageData(cur);
