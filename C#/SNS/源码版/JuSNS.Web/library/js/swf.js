...
n.innerHTML=this.getSWFHTML();return true;
	...
	// FlashPlayer版本不对时
	if(window.downloadFlashPlayer != true) {
		alert("您的当前的Flash Player版本无法支持,请下载最新版");
		window.open("http://down1.tech.sina.com.cn/download/down_page/1081612800/1149.shtml", "downFlashPlayer");
	}
	window.downloadFlashPlayer = true;
