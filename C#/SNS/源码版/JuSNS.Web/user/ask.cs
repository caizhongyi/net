...
namespace JuSNS.Web.user
{
    public class ask : BasePage
    {
            ...
            else
            {
                ...
                if (userinfo != null)
                {
                    ...
                    else
                    {
                        ...
                        context.Put("cpagetitle", "问答 - " + userinfo.TrueName + "的空间");
        ...
        protected void ShowList(ref VelocityContext context, int userid)
        {
            ...
            DataTable dt = JuSNS.Home.UtilPage.GetAskPage(userid.ToString(), string.Empty, 0, uid, PageIndex, recount, out ReCount, out PgCount, st);
            if (PgCount < 1) { PgCount = 1; }
