...
{
    public class shopclass_add : ManagePage
    {
        ...
        protected void ShowInfo(ref NVelocity.VelocityContext context)
        {
            ...
            if (classid > 0)
            {
                ...
                ShopClassInfo info = JuSNS.Home.App.Shop.Instance.GetShopClassInfo(classid);
                sid = info.ParentID;
        ...
        public override void Page_PostBack(ref VelocityContext context)
        {
            ...
            else
            {
                ...
                info.IsLock = false;
                int n = JuSNS.Home.App.Shop.Instance.InsertShopClass(info);
                if (n > 0)
                {
                    context.Put("redirecturl", "shopclass" + ExName);
                }
                else
                {
