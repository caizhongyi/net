...
namespace JuSNS.Cache
{
	...
	public class MemcachedClient 
	{
        ...
        /// <param name="command">命令行参数，该参数为JuSNSNT修改版</param>
        ...
        private static ResourceManager _resourceManager = new ResourceManager("JuSNS.Cache.MemCached.StringMessages", typeof(MemcachedClient).Assembly);
