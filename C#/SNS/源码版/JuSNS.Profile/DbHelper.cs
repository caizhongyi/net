...
namespace JuSNS.Profile
{
    public abstract class DbHelper
    {
        ...
        {
            return ExecuteNonQuery(DBConfig.CnString, cmdType, cmdText, commandParameters);
        }
        ...
        {
            return ExecuteReader(DBConfig.CnString, cmdType, cmdText, commandParameters);
        }
        ...
        {
            return ExecuteScalar(DBConfig.CnString, cmdType, cmdText, commandParameters);
        }
        ...
        {
            return ExecuteTable(DBConfig.CnString, cmdType, cmdText, commandParameters);
        }
        ...
        /// <returns></returns>
        public static DataTableCollection ExecuteTables(DbConnection connection, CommandType cmdType, string cmdText, params DbParameter[] commandParameters)
        {
            DbCommand cmd = Provider.CreateCommand();
            PrepareCommand(cmd, connection, null, cmdType, cmdText, commandParameters);
            DbDataAdapter ap = Provider.CreateDataAdapter();
        ...
        {
            return ExecutePage(DBConfig.CnString, SqlAllFields, SqlTablesAndWhere, IndexField, OrderFields, PageIndex, PageSize, out  RecordCount, out  PageCount, commandParameters);
        }
