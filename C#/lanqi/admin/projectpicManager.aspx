<%@ Page Language="C#" AutoEventWireup="true" CodeFile="projectpicManager.aspx.cs" Inherits="admin_projectpicManager" %>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CEDDE6" style="text-align:center" >
      <tbody>
        <tr align="center" bgcolor="#ffffff" onmouseover="this.style.backgroundColor='#ECF4F9'" onmouseout="this.style.backgroundColor='#fff'">
          <td align="center" background="images/tablethbg.gif" class="ff00" style=" width: 14%;" ><strong>网站名称</strong></td>
          <td align="center" background="images/tablethbg.gif" class="ff00" style=" width: 17%;" ><b>申请广告</b></td>
         <td align="center" background="images/tablethbg.gif" class="ff00" style=" width: 17%;" ><b>生成链接</b></td>
         <td align="center" background="images/tablethbg.gif" class="ff00" style=" width: 17%;" ><b>点击数</b></td>
           <td align="center" background="images/tablethbg.gif" class="ff00" style=" width: 17%;" ><b>申请时间</b></td>
       ...
       <asp:Repeater ID="rpNews" runat="server"  >
          ...
          <td height="30" align="left" class="table1" style="text-align:center"  ><%# Eval("pname") %></td> 
       ...
       <td height="30" align="left" class="table1" style="text-align:center"  ><%# Eval("join_date") %></td> 
