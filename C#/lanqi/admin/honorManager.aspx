<%@ Page Language="C#" AutoEventWireup="true" CodeFile="honorManager.aspx.cs" Inherits="honorManager"  %>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CEDDE6" style="text-align:center" >
      <tbody>
        <tr align="center" bgcolor="#ffffff" onmouseover="this.style.backgroundColor='#ECF4F9'" onmouseout="this.style.backgroundColor='#fff'">
          <td  width="21%"align="center" background="images/tablethbg.gif" class="ff00" style="height: 30px; width: 14%;" ><strong>班级信息</strong></td>
           <td  align="center" background="images/tablethbg.gif" class="ff00" style="height: 30px" ><b>信息分类</b></td>
          <td width="21%" align="center" background="images/tablethbg.gif" class="ff00" style="height: 30px" ><b>信息内容</b></td>
       ...
       <asp:Repeater ID="rpNews" runat="server"  >
          ...
          <td height="30" align="left" class="table1" style="text-align:center"  ><%# Eval("name")%></td>
           <td height="30" align="left" class="table1" style="text-align:center"  ><%# fun.getById(Eval("typeid").ToString(),"id","honortype","type")%></td>
          <td height="30" align="left" class="table1" style="text-align:center"  ><%# fun.Left(re.CheckStr(Eval("honor_content").ToString()), 10)%></td>
          
       
         
          <td align="center" class="table1" style="text-align:center"  ><%# Eval("addtime") %></td>
          
           <td align="center" class="table1" ><a href=HonorAdd.aspx?id=<%# Eval("id") %>>查看详细</a></td>
