<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cultureType.aspx.cs" Inherits="admin_cultureType" %>
...
<body style="text-align:center; height:1300px">
   <form id="Form1" action=""  runat=server>
                        ...
                        <div class="page">
       <br />
                            上级分类：<select id="slDy" runat=server>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CEDDE6">
      <tbody>
        <tr align="center" bgcolor="#ffffff" onmouseover="this.style.backgroundColor='#ECF4F9'" onmouseout="this.style.backgroundColor='#fff'">
          ...
          <td  align="center" background="images/tablethbg.gif" class="ff00" style="height: 28px" ><b>分类名称</b></td>
         ...
         <asp:Repeater ID="rpNewClass3" runat="server">
          ...
          <td  width="25%" align="center" class="table1" ><a href=cultureTypeAdd.aspx?id=<%# Eval("id")%>&type=3 >修改</a></td>
