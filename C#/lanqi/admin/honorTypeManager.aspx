<%@ Page Language="C#" AutoEventWireup="true" CodeFile="honorTypeManager.aspx.cs" Inherits="admin_honorTypeManager" %>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CEDDE6">
      <tbody>
        <tr align="center" bgcolor="#ffffff" onmouseover="this.style.backgroundColor='#ECF4F9'" onmouseout="this.style.backgroundColor='#fff'">
          ...
          <td  align="center" background="images/tablethbg.gif" class="ff00" style="height: 28px" ><b>专业名称</b></td>
         ...
         <asp:Repeater ID="rpNewClass3" runat="server">
          ...
          <td  width="20%" align="center" class="table1" ><%# Eval("type")  %></td>
          
          <td  width="25%" align="center" class="table1" ><a href=honorTypeAdd.aspx?id=<%# Eval("id")%>&type=3 >修改</a></td>
