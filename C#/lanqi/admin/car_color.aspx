<%@ Page Language="C#" AutoEventWireup="true" CodeFile="car_color.aspx.cs" Inherits="admin_car_color" %>
...
<body style="text-align:center; height:1300px">
  ...
  <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                        ...
                        <div class="page">
       <br /> 汽车型号：&nbsp; <asp:DropDownList ID="DropDownList1" runat="server" 
                                DataSourceID="SqlDataSource1" DataTextField="xname" DataValueField="xid" 
                              >
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CEDDE6">
      <tbody>
        <tr align="center" bgcolor="#ffffff" onmouseover="this.style.backgroundColor='#ECF4F9'" onmouseout="this.style.backgroundColor='#fff'">
          ...
          <td  align="center" background="images/tablethbg.gif" class="ff00" style="height: 28px" ><b>汽车颜色名称</b></td>
         <td  align="center" background="images/tablethbg.gif" class="ff00" style="height: 28px" ><b>汽车型号名称</b></td>
         ...
         <asp:Repeater ID="rpNewClass3" runat="server">
          <ItemTemplate>
          <tr align="center" bgcolor="#ffffff" onmouseover="this.style.backgroundColor='#ECF4F9'" onmouseout="this.style.backgroundColor='#fff'">
          <td  width="25%" height="30" align="left" class="table1" style="text-align:center" ><a  ><%# Eval("colorid")%></a></td>
          <td  width="25%" align="center" class="table1" ><%# Eval("colorname")%></td>
          <td  width="25%" align="center" class="table1" ><%# Eval("xname")%></td>
          <td  width="25%" align="center" class="table1" ><a href=car_color.aspx?cid=<%# Eval("colorid")%>>修改</a></td>
            
          <td align="center" class="table1" ><a href="#"></a>
            <input type="checkbox" name="ch3" value=<%# Eval("colorid") %> /></td>
         </tr>
          </ItemTemplate>
          </asp:Repeater>
        <tr align="center" bgcolor="#ffffff" onmouseover="this.style.backgroundColor='#ECF4F9'" onmouseout="this.style.backgroundColor='#fff'">
          <td height="30" colspan="5" align="right" class="table1" ><input type="button" name="Submit5" value="全选" onclick="checkall('ch3')" />
