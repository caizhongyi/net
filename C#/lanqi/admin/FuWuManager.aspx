<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FuWuManager.aspx.cs" Inherits="admin_FuWuManager" %>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CEDDE6" style="text-align:center" >
      <tbody>
        <tr align="center" bgcolor="#ffffff" onmouseover="this.style.backgroundColor='#ECF4F9'" onmouseout="this.style.backgroundColor='#fff'">
          <td align="center" background="images/tablethbg.gif" class="ff00" style="height: 30px; width: 14%;" ><strong>信息名称</strong></td>
          <td align="center" background="images/tablethbg.gif" class="ff00" style="height: 30px; width: 20%;" ><b>信息内容</b></td>
         
           
          <td align="center" background="images/tablethbg.gif" class="ff00" style="height: 30px; width: 10%;" ><b>添加时间</b></td>
       ...
       <asp:Repeater ID="rpNews" runat="server"  >
          ...
          <td height="30" align="left" class="table1" style="text-align:center"  ><%# fun.Left(Eval("content").ToString(), 25)%></td>
          
       
         
          <td align="center" class="table1" style="text-align:center"  ><%# Eval("join_date") %></td>
          
           <td align="center" class="table1" ><a href=FuWu.aspx?id=<%# Eval("id") %>>查看详细</a></td>
