<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewsClassAdd.aspx.cs" Inherits="admin_NewsClassAdd" %>
      ...
      <table cellspacing="1" cellpadding="2" width="100%" align="center" bgcolor="#000000" border="0">
        <tbody>
          ...
          <tr bgcolor="#ffffff" runat=server id=title>
            <td valign="center" width="283" height="25"><strong>选择所属类别：</strong></td>
