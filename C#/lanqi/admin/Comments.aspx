<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Comments.aspx.cs" Inherits="admin_NewManager2" %>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CEDDE6">
      <tbody>
        <tr align="center" bgcolor="#ffffff" onmouseover="this.style.backgroundColor='#ECF4F9'" onmouseout="this.style.backgroundColor='#fff'">
          ...
          <td width="21%" align="center" background="images/tablethbg.gif" class="ff00" style="height: 30px" ><b>用户名称</b></td>
       ...
       <asp:Repeater ID="rpNews" runat="server" OnItemCommand="rpNews_ItemCommand"  >
          <ItemTemplate>
          <tr align="center" bgcolor="#ffffff" onmouseover="this.style.backgroundColor='#ECF4F9'" onmouseout="this.style.backgroundColor='#fff'">
          <td height="30" align="left" class="table1" ><%# fun.Left(Eval("username").ToString(), 8)%></td>
          <td class="table1" ><%# fun.Left(Eval("c_content").ToString(),8) %></td>

          <td align="center" class="table1" ><a href='CommentsAdd.aspx?id=<%# Eval("c_id")%>'>查看详细</a></td>
          <td align="center" class="table1" ><a href="#"></a>
            <input type="checkbox" name="ch" value='<%# Eval("c_id") %>' id="ch" /></td>
          </tr>
          </ItemTemplate>
          </asp:Repeater>
        <tr align="center" bgcolor="#ffffff" onmouseover="this.style.backgroundColor='#ECF4F9'" onmouseout="this.style.backgroundColor='#fff'">
