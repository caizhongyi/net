<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductClass2.aspx.cs" Inherits="admin_ProductClass2" %>
      ...
      <tbody>
        <tr align="center" bgcolor="#ffffff" onmouseover="this.style.backgroundColor='#ECF4F9'" onmouseout="this.style.backgroundColor='#fff'">
         ...
         <asp:Repeater ID="rpNewClass3" runat="server">
          ...
          <td  width="25%" align="center" class="table1" ><a href=productClassAdd2.aspx?id=<%# Eval("id")%>&type=3 >修改</a></td>
