<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Advice.aspx.cs" Inherits="Advice" %>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CEDDE6" style="text-align:center" >
      <tbody>
        <tr align="center" bgcolor="#ffffff" onmouseover="this.style.backgroundColor='#ECF4F9'" onmouseout="this.style.backgroundColor='#fff'">
          <td align="center" background="images/tablethbg.gif" class="ff00" style="height: 30px; width: 14%;" ><strong>简介标题</strong></td>
          <td width="21%" align="center" background="images/tablethbg.gif" class="ff00" style="height: 30px" ><b>简介内容</b></td>
       ...
       <asp:Repeater ID="rpNews" runat="server"  >
          ...
          <td align="center" class="table1" style="text-align:center"  ><%# Eval("join_date") %></td>
           ...
           <td align="center" class="table1" ><a href=AdviceAdd.aspx?id=<%# Eval("id") %>>查看详细</a></td>
