<%@ Page Language="C#" AutoEventWireup="true" CodeFile="zhuangyeManager.aspx.cs" Inherits="admin_zhuangyeManager" %>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CEDDE6">
      <tbody>
        <tr align="center" bgcolor="#ffffff" onmouseover="this.style.backgroundColor='#ECF4F9'" onmouseout="this.style.backgroundColor='#fff'">
          <td  align="center" background="images/tablethbg.gif" class="ff00" style="height: 28px; width: 227px;" ><strong>班级编号</strong></td>
          <td  align="center" background="images/tablethbg.gif" class="ff00" style="height: 28px" ><b>班级名称</b></td>
       
          <td  align="center" background="images/tablethbg.gif" class="ff00" style="height: 28px" ><b>修改名称</b></td>
           <td  align="center" background="images/tablethbg.gif" class="ff00" style="height: 28px" ><b>修改专业</b></td>
         ...
         <asp:Repeater ID="rpNewClass3" runat="server">
          <ItemTemplate>
          <tr align="center" bgcolor="#ffffff" onmouseover="this.style.backgroundColor='#ECF4F9'" onmouseout="this.style.backgroundColor='#fff'">
          <td  width="20%" height="30" align="left" class="table1" style="text-align:center" ><a  ><%# Eval("id") %></a></td>
          <td  width="20%" align="center" class="table1" ><%# Eval("name")  %></td>
          
          <td  width="25%" align="center" class="table1" ><a href=zhuangyeadd.aspx?id=<%# Eval("id")%>&type=3 >修改名称</a></td>
            <td  width="25%" align="center" class="table1" ><a href=xiugaizhuangye.aspx?id=<%# Eval("id")%>&name=<%# Eval("name")%> >修改课程</a></td>
