<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ygfcManager.aspx.cs" Inherits="admin_ygfcManager" validateRequest="false"  %>
...
<body>
  ...
  <form id="Form1" action=""  runat=server>
      <br />
  <center><a href=ygfcAdd.aspx>添加</a></center>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CEDDE6" style="text-align:center" >
      <tbody>
        <tr align="center" bgcolor="#ffffff" onmouseover="this.style.backgroundColor='#ECF4F9'" onmouseout="this.style.backgroundColor='#fff'">
          <td align="center" background="images/tablethbg.gif" class="ff00" style="height: 30px; width: 14%;" ><strong>旅行社名称</strong></td>
          <td width="9%" align="center" background="images/tablethbg.gif" class="ff00" style="height: 30px" ><b>分类</b></td>
          <td width="21%" align="center" background="images/tablethbg.gif" class="ff00" style="height: 30px" ><b>描述内容</b></td>
       ...
       <asp:Repeater ID="rpNews" runat="server"  >
          ...
          <td height="30" align="left" class="table1" style="text-align:center"  ><%# fun.getById(Eval("typeid").ToString(),"id","ygfctype","type")%></td>
          <td height="30" align="left" class="table1" style="text-align:center"  ><%# fun.Left(Eval("honor_content").ToString(), 8)%></td>
          
       
         
          <td align="center" class="table1" style="text-align:center"  ><%# Eval("addtime") %></td>
          
           <td align="center" class="table1" ><a href=ygfcAdd.aspx?id=<%# Eval("id") %>>查看详细</a></td>
