<%@ Page Language="C#" AutoEventWireup="true" CodeFile="jobManager.aspx.cs" Inherits="admin_jobManager" %>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CEDDE6" style="text-align:center" >
      <tbody>
        <tr align="center" bgcolor="#ffffff" onmouseover="this.style.backgroundColor='#ECF4F9'" onmouseout="this.style.backgroundColor='#fff'">
          <td align="center" background="images/tablethbg.gif" class="ff00" style="height: 30px; width: 14%;" ><strong>招聘职位</strong></td>
          <td width="21%" align="center" background="images/tablethbg.gif" class="ff00" style="height: 30px" ><b>招聘人数</b></td>
          <td width="15%" background="images/tablethbg.gif" class="ff00" style="height: 30px" ><b>工作地点</b></td>
          <td width="5%" background="images/tablethbg.gif" class="ff00" style="height: 30px" ><b>工资水平</b></td>
          <td width="5%" background="images/tablethbg.gif" class="ff00" style="height: 30px" ><b>招聘期限</b></td>
       ...
       <asp:Repeater ID="rpNews" runat="server"  >
          <ItemTemplate>
          <tr align="center" bgcolor="#ffffff" onmouseover="this.style.backgroundColor='#ECF4F9'" onmouseout="this.style.backgroundColor='#fff'">
          <td height="30" align="left" class="table1" style="text-align:center"  ><%# fun.Left(Eval("inviter").ToString(), 8)%></td>
          <td height="30" align="left" class="table1" style="text-align:center"  ><%# fun.Left(Eval("renshu").ToString(), 8)%></td>
          
          <td class="table1" style="text-align:center"  ><%# Eval("address") %></td>
           <td height="30" align="left" class="table1" style="text-align:center" ><%# Eval("gongzi") %></td>
           <td height="30" align="left" class="table1" style="text-align:center" ><%# Eval("qixian") %></td>
         
          <td align="center" class="table1" style="text-align:center"  ><%# Eval("join_date") %></td>
          
           <td align="center" class="table1" ><a href=jobAdd.aspx?id=<%# Eval("id") %>>查看详细</a></td>
        ...
        <tr align="center" bgcolor="#ffffff" onmouseover="this.style.backgroundColor='#ECF4F9'" onmouseout="this.style.backgroundColor='#fff'">
          <td height="30" colspan="8" align="right" class="table1" ><input type="button" name="Submit5" value="全选" onclick="checkall()" id="Button2" />&nbsp;
