<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cultureManager.aspx.cs" Inherits="admin_cultureManager" %>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CEDDE6" style="text-align:center" >
      <tbody>
        <tr align="center" bgcolor="#ffffff" onmouseover="this.style.backgroundColor='#ECF4F9'" onmouseout="this.style.backgroundColor='#fff'">
          <td width="21%" align="center" background="images/tablethbg.gif" class="ff00" style="height: 30px; width: 14%;" ><strong>风景名称</strong></td>
          <td width="9%"  align="center" background="images/tablethbg.gif" class="ff00" style="height: 30px" ><b>风景分类</b></td>
          <td width="21%" align="center" background="images/tablethbg.gif" class="ff00" style="height: 30px" ><b>风景内容</b></td>
         
           
          <td width="9%" align="center" background="images/tablethbg.gif" class="ff00" style="height: 30px" ><b>添加时间</b></td>
          <td  align="center" background="images/tablethbg.gif" class="ff00" style="height: 28px" ><b>排序</b></td>
       ...
       <asp:Repeater ID="rpNews" runat="server"  >
          <ItemTemplate>
          <tr align="center" bgcolor="#ffffff" onmouseover="this.style.backgroundColor='#ECF4F9'" onmouseout="this.style.backgroundColor='#fff'">
          <td height="30" align="left" class="table1" style="text-align:center"  ><%# Eval("title")%></td>
           <td height="30" align="left" class="table1" style="text-align:center"  ><%# fun.getById(Eval("typeid").ToString(),"id","culturetype","type")%></td>
          <td height="30" align="left" class="table1" style="text-align:center"  ><%# fun.Left(Eval("content").ToString(), 8)%></td>
          ...
          <td align="center" class="table1" style="text-align:center"  ><%# Eval("join_date") %></td>
           ...
           <td align="center" class="table1" ><a href=culture.aspx?id=<%# Eval("id") %>>查看详细</a></td>
