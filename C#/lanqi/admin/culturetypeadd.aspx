<%@ Page Language="C#" AutoEventWireup="true" CodeFile="culturetypeadd.aspx.cs" Inherits="admin_culturetypeadd" %>
...
<body style="height:1200px">
    ...
    <div>
      <table cellspacing="1" cellpadding="2" width="100%" align="center" bgcolor="#000000" border="0">
        <tbody>
          <tr bgcolor="#ffffff">
            <td height="22" colspan="2" align="center" background="../Images/bg_list.gif" bgcolor="#6699cc"><span class="STYLE1">风景分类</span></td>
          </tr>
