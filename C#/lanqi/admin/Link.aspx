...
<body>
  ...
  <form id="Form1" action=""  runat=server>
      <br />  <center><a href=LinkAdd.aspx>添加</a></center>
      <br />
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CEDDE6" style="text-align:center" >
      <tbody>
        <tr align="center" bgcolor="#ffffff" onmouseover="this.style.backgroundColor='#ECF4F9'" onmouseout="this.style.backgroundColor='#fff'">
          <td align="center" background="images/tablethbg.gif" class="ff00" style="height: 30px; width: 14%;" ><strong>链接名称</strong></td>
          <td width="21%" align="center" background="images/tablethbg.gif" class="ff00" style="height: 30px" ><b>链接网址</b></td>
         
          <td width="15%" align="center" background="images/tablethbg.gif" class="ff00" style="height: 30px" ><b>类型</b></td>
       ...
       <asp:Repeater ID="rpNews" runat="server"  >
          <ItemTemplate>
          <tr align="center" bgcolor="#ffffff" onmouseover="this.style.backgroundColor='#ECF4F9'" onmouseout="this.style.backgroundColor='#fff'">
          <td height="30" align="left" class="table1" style="text-align:center"  ><%# Eval("web_name")%></td>
          <td height="30" align="left" class="table1" style="text-align:center"  ><%# fun.Left(Eval("web_address").ToString(), 8)%></td>
          
          <td height="30" align="left" class="table1" style="text-align:center"  ><%# Eval("type").ToString()=="0"?"友情链接":"广告"%></td>
         
          <td align="center" class="table1" style="text-align:center"  ><%# Eval("addtime") %></td>
          
           <td align="center" class="table1" ><a href=LinkAdd.aspx?id=<%# Eval("id") %>>查看详细</a></td>
