<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ygfcType.aspx.cs" Inherits="admin_ygfcType" %>
      ...
      <tbody>
        <tr align="center" bgcolor="#ffffff" onmouseover="this.style.backgroundColor='#ECF4F9'" onmouseout="this.style.backgroundColor='#fff'">
         ...
         <asp:Repeater ID="rpNewClass3" runat="server">
          ...
          <td  width="25%" align="center" class="table1" ><a href=ygfcTypeAdd.aspx?id=<%# Eval("id")%>&type=3 >修改</a></td>
