<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewClass2.aspx.cs" Inherits="admin_NewClass2" %>
   ...
   <form id="Form1" action=""  runat=server>
      ...
      <tbody>
        <tr align="center" bgcolor="#ffffff" onmouseover="this.style.backgroundColor='#ECF4F9'" onmouseout="this.style.backgroundColor='#fff'">
         ...
         <td  align="center" background="images/tablethbg.gif" class="ff00" style="height: 28px" ><a href=newsclassadd2.aspx?id=<%# Eval("id") %>&type=news_class2>修改</a></td>
