<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductAdd.aspx.cs" Inherits="admin_ProductAdd" %>
      ...
      <tbody>
        ...
        <tr align="center" bgcolor="#ffffff" onmouseover="this.style.backgroundColor='#ECF4F9'" onmouseout="this.style.backgroundColor='#fff'">
          ...
          <td align="left" class="table1" >
              &nbsp;<input id="number" style="width: 42px" type="text" runat=server />&nbsp; 是否推荐：
        ...
        <tr align="center" bgcolor="#ffffff" onmouseover="this.style.backgroundColor='#ECF4F9'" onmouseout="this.style.backgroundColor='#fff'">
          <td align="right">产品详细说明：<td align="left" valign="top" class="table1" ><textarea runat=server name="explain" cols="65" rows="30" id="explain"></textarea></td>
        </tr>
        <tr align="center" bgcolor="#ffffff" onmouseover="this.style.backgroundColor='#ECF4F9'" onmouseout="this.style.backgroundColor='#fff'">
