<%@ Page Language="C#" AutoEventWireup="true" CodeFile="subNewClass.aspx.cs" Inherits="admin_NewClass" %>
...
<body style="text-align:center;  height:1100px">
   <form id="Form1" action=""  runat=server>
       ...
       <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>&nbsp;<asp:Button ID="Button2"
            runat="server" OnClick="Button2_Click" Text="添加" Width="56px" />
  <ul><br />
      ...
      <tbody>
        <tr align="center" bgcolor="#ffffff" onmouseover="this.style.backgroundColor='#ECF4F9'" onmouseout="this.style.backgroundColor='#fff'">
         ...
         <asp:Repeater ID="rpNewClass2" runat="server">
          ...
          <tr align="center" bgcolor="#ffffff" onmouseover="this.style.backgroundColor='#ECF4F9'" onmouseout="this.style.backgroundColor='#fff'">
          <td height="30" align="left" class="table1" style="text-align:center" ><a  ><%# Eval("id")  %></a></td>
          <td align="center" class="table1" ><%# Eval("type") %></td>
         <td  align="center" background="images/tablethbg.gif" class="ff00" style="height: 28px" ><a href=newsclassadd.aspx?id=<%# Eval("id") %>&type=news_class2>修改</a></td>
