<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductClass1.aspx.cs" Inherits="admin_ProductClass1" %>
...
<body style="text-align:center; height:1300px">
   <form id="Form1" action=""  runat=server>
       <br />
                        ...
                        <div class="page">
       <asp:Label ID="Label1" runat="server" Text="产品一级类别"></asp:Label><br />
                            &nbsp;
      ...
      <tbody>
        <tr align="center" bgcolor="#ffffff" onmouseover="this.style.backgroundColor='#ECF4F9'" onmouseout="this.style.backgroundColor='#fff'">
         ...
         <asp:Repeater ID="rpNewClass2" runat="server">
          ...
          <td  width="25%" align="center" class="table1" ><a href=productClassAdd1.aspx?id=<%# Eval("id") %>&type=2>修改</a></td>
