<%@ Page Language="C#" AutoEventWireup="true" CodeFile="YPManager.aspx.cs" Inherits="admin_YPManager" %>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CEDDE6" style="text-align:center" >
      <tbody>
        <tr align="center" bgcolor="#ffffff" onmouseover="this.style.backgroundColor='#ECF4F9'" onmouseout="this.style.backgroundColor='#fff'">
          ...
          <td width="21%" align="center" background="images/tablethbg.gif" class="ff00" style="height: 30px" ><b>应聘人员</b></td>
       ...
       <asp:Repeater ID="rpNews" runat="server"  >
          <ItemTemplate>
          <tr align="center" bgcolor="#ffffff" onmouseover="this.style.backgroundColor='#ECF4F9'" onmouseout="this.style.backgroundColor='#fff'">
          <td height="30" align="left" class="table1" style="text-align:center"  ><%# fun.getById(Eval("ypnameid").ToString(),"id","job","inviter")%></td>
          <td height="30" align="left" class="table1" style="text-align:center"  ><%# fun.Left(Eval("txtname").ToString(), 8)%></td>
          
       
         
          <td align="center" class="table1" style="text-align:center"  ><%# Eval("addtime") %></td>
          
           <td align="center" class="table1" ><a href=jobYP.aspx?id=<%# Eval("id") %>>查看详细</a></td>
