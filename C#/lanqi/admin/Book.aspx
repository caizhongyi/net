    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CEDDE6">
      <tbody>
        <tr align="center" bgcolor="#ffffff" onmouseover="this.style.backgroundColor='#ECF4F9'" onmouseout="this.style.backgroundColor='#fff'">
          <td align="center" background="images/tablethbg.gif" class="ff00" style="height: 30px; width: 23%;" ><strong>报名用户</strong></td>
          <td width="21%" align="center" background="images/tablethbg.gif" class="ff00" style="height: 30px" ><b>报名专业</b></td>
          ...
          <ItemTemplate>
          <tr align="center" bgcolor="#ffffff" onmouseover="this.style.backgroundColor='#ECF4F9'" onmouseout="this.style.backgroundColor='#fff'">
          <td height="30" align="center" class="table1" ><%# fun.getById( Eval("user_id").ToString(),"id","usercenter","username") %></td>
          <td align="center" class="table1" ><%# fun.getById( Eval("product_id").ToString(),"id","honortype","type") %></td>
     
           <td align="center" class="table1" ><a href=Useradd.aspx?id=<%# Eval("user_id") %>>查看详细</a></td>
