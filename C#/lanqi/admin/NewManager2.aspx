<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewManager2.aspx.cs" Inherits="admin_NewManager2" %>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CEDDE6">
      <tbody>
        <tr align="center" bgcolor="#ffffff" onmouseover="this.style.backgroundColor='#ECF4F9'" onmouseout="this.style.backgroundColor='#fff'">
          <td align="center" background="images/tablethbg.gif" class="ff00" style="height: 30px; width: 14%;" ><strong>信息标题</strong></td>
          <td width="21%" align="center" background="images/tablethbg.gif" class="ff00" style="height: 30px" ><b>信息类别</b></td>
          <td width="15%" background="images/tablethbg.gif" class="ff00" style="height: 30px" ><b>信息内容</b></td>
          ...
          <td width="5%" background="images/tablethbg.gif" class="ff00" style="height: 30px" ><b>排序</b></td>
           <td background="images/tablethbg.gif" class="ff00" style="height: 30px; width: 4%;" ><b>是否推荐</b></td>
          <td align="center" background="images/tablethbg.gif" class="ff00" style="height: 30px; width: 12%;" ><b>添加时间</b></td>
       ...
       <asp:Repeater ID="rpNews" runat="server" OnItemCommand="rpNews_ItemCommand"  >
          ...
          <td align="center" class="table1" ><%#  fun.getById(Eval("class1_id").ToString(),"id","news_class2","type") %></td>
          ...
          <td align="center" class="table1" ><%# Eval("join_date") %></td>
           ...
           <td align="center" class="table1" ><a href=NewAdd2.aspx?id=<%# Eval("id") %>>查看详细</a></td>
